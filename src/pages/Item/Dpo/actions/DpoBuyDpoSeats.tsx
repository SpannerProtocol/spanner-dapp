 ...
 */
export function DpoBuyDpoSeatsAvailable({ dpoInfo, dpoAction }: { dpoInfo: DpoInfo; dpoAction: DpoAction }) {
 ...
 */
export function DpoBuyDpoSeatsNotAvailable({ dpoInfo, dpoAction }: { dpoInfo: DpoInfo; dpoAction: DpoAction }) {
  const [estimatedFee, setEstimatedFee] = useState<string>()
    ...
    ;(async () => {
      try {
        if (targetType === 'TravelCabin') {
          console.log('targettype travelcabin')

...
import BulletTrainStats from 'pages/BulletTrains/Stats'
import { CabinsSection } from 'pages/BulletTrains/Cabins'
import { GlobalMilestoneReward } from 'pages/BulletTrains/Milestone'
